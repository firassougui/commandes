		...
		<div id="app" class="page">
			<div class="main-wrapper" >
					...
					<ul class="navbar-nav navbar-right">
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
								<span class="mr-3 mt-2 d-none d-lg-block ">
							              ...
							              foreach($info as $row){
								           ?>
									<span class="text-white">Hello,<span class="ml-1">  <?PHP echo $row['login'];}?></span></span>
								</span>
							...
							foreach($info as $row){
								?>
									<h5 class="text-capitalize text-dark mb-1"> <?PHP echo $row['login'];?> </h5>
									<small class="text-overflow m-0">Role : <?PHP echo $row['role'];}?></small>
								</div>
				...
				<aside class="app-sidebar">
					<div class="app-sidebar__user">
						<div class="dropdown user-pro-body text-center">
							...
							foreach($info as $row){
								?>
								<h6 class=" mb-1 text-dark"><?PHP echo $row['login'];?></h6>
								<span class="text-muted app-sidebar__user-name text-sm"><?PHP echo $row['role'];}?></span>
							</div>
						</div>
					</div>
					<ul class="side-menu">
						...
						<li>
							<a class="side-menu__item" href="AfficherBack.php"><i class="side-menu__icon fe fe-grid"></i><span class="side-menu__label">Commandes</span></a>
						</li>
						<li class="slide">
				...
				<div class="page-header" >
					<h6 class="page-title">Liste des commandes</h6>
				</div>
...
foreach($listeCC as $row){
	...
	<td><form method="POST" action="../views/AnnulerCommande1.php">
	...
	<a href="../views/ConfirmerCommande.php?id_com=<?PHP echo $row['id_com'].'&etat='.$row['etat']; ?>">Confirmer </a>
